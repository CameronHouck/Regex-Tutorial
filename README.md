...
regex is a smart method to find patterns in text for editing code verifiying emails/user input etc.
it can be used to validate emails and replace a string using regex and python.
and explanation is shown below and a tutorial video if you are confused and need a different approach of understanding.
...
GitHub: https://github.com/CameronHouck

## Demo

Use this video to get a better understanding if you need to.

https://www.youtube.com/watch?v=UQQsYXa1EHs

Kite is also very useful in the video shown above!
